...
public:
    ...
    void save_route()
    {
        ...
        // string path = ros::package::getPath("info_stereo_vis_odom");
        // cout << "\n"
        //      << path
        //      << "\n"
        //      << endl;
        ...
        // string pwd_file;
        // pwd_file.append("/home/johanp/vo_ws/src/StereoVisOdom/KITTI/route/route_v2.txt");
        // // pwd_file.append("/home/sirui/vo_ws/src/StereoVisOdom/KITTI/route/route_v2.txt");
        // //  pwd_file.append("/home/avila/vo_ws/src/StereoVisOdom/KITTI/route/route_v2.txt");
        // ofstream file;
        // file.open(pwd_file);
...
int main(int argc, char *argv[])
{
    ...
    ROS_INFO("\033[1;32m-> KITTI.\033[0m");
    while (ros::ok())
    {
